"""Regenerate the R=1 Ising figures using Figure Style v1.3.
...
def correlation_length():
    ...
    a += [
        ...
        math_text(409, 420, [("mi", "T"), ("mo", " / "), ("mi", "J")], anchor="middle"),
        math_text(29, 188, [("mi", "ξ")], anchor="middle", transform="rotate(-90 29 188)"),
    ]
    ex, ap = [], []
    for i in range(101):
    ...
    for idx, (pl, pr, q) in enumerate(zip(pls, prs, [math.pi / 10, math.pi / 2])):
        ...
        a += [
            ...
            math_text(
                pl + 44,
                pt + 22,
                [("mi", "q"), ("mo", " = "), ("mconst", "π"), ("mo", "/"), ("mn", denom)],
                cls="panelmath",
            ),
            math_text((pl + pr) / 2, 410, [("mi", "i")], anchor="middle"),
        ]
        if idx == 0:
            a.append(
                math_text(
