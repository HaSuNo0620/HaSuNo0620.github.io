---
title: "1次元一様第二近接 cosine-U(1) スピン系 — 螺旋・カイラリティ記憶と応答"
summary: "第二近接相互作用を持つ1次元U(1) cosineスピン鎖を、相互作用する位相増分、有限ねじれ、連続場、螺旋相関、カイラリティキンク、転送作用素、複数の記憶長、一様・周期・回転外場への応答まで一つの模型ノートとして整理する。"
...
第二近接 (U(1)) 系では、スピン方向の記憶と右巻き・左巻きの記憶が同じ長さで減衰するとは限らない。ここからはカイラリティを独立した記憶チャネルとして分離して読む。
...
という二つの記憶長の差は、同じ外場応答だけから自動的に同定できるわけではない。
