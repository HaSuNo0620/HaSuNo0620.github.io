...
summary: "有限範囲の1次元U(1) cosineスピン鎖を、連続位相増分の有限履歴、(S1)^(R-1)上の転送作用素、複数の選好ねじれ、相関モード競合という構造で整理する。R=1の位相拡散とR=2の螺旋記憶を一般の有限範囲へ拡張する。"
...
局所記憶変数は一貫して $\phi_i$ であり、相互作用範囲だけを伸ばす。
